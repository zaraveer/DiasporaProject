<div class="container">
	...
	<!-- Tab panes -->
  	<div class="tab-content">
		<div class="col-md-12 tab-pane <?php if($profile == "edit") { echo "active"; }else if(empty($profile)){ echo "active"; } ?>" id="main">
			<form id="basicForm" method="post" action="profile/update" class="form-horizontal">
				...
				<div class="col-md-6">
				  	...
				  	<div class="form-group">
						<label class="col-sm-3 control-label">
							Nama awal <span class="text-danger">*</span>
						</label>
						<div class="col-sm-8">
				  	...
				  	<div class="form-group">
						<label class="col-sm-3 control-label">
							Nama akhir <span class="text-danger">*</span>
						</label>
						<div class="col-sm-8">
		...
		<div class="col-md-12 tab-pane <?php if($profile == "about") { echo "active"; } ?>" id="about">
			<form id="basicForm" action="profile/updateabout" method="post" class="form-horizontal col-md-12">
				<div class="col-md-12">
				  	<input type="hidden" name="iduser" class="form-control" value="<?php echo htmlspecialchars($user->id,ENT_QUOTES,'UTF-8');?>" required />
				  	<div class="form-group">
					  	<textarea id="wysiwyg" name="aboutme" placeholder="Enter text here..." class="form-control" rows="10">	
					  		<?php echo htmlspecialchars($user->aboutme,ENT_QUOTES,'UTF-8');?>			  		
					  	</textarea>
					</div>
				  	<div class="form-group">
						<button class="btn btn-success btn-quirk btn-wide mr5">Lanjutkan</button>
		...
		<div class="col-md-12 tab-pane <?php if($profile == "picture") { echo "active"; } ?>" id="activity">
			<div class="col-md-4">
			  	<div class="panel">
		...
		<div class="col-md-12 tab-pane <?php if($profile == "password") { echo "active"; } ?>" id="photos">
		  	<form id="basicForm" action="auth/change_password" method="post" class="form-horizontal col-md-12">
				<div class="col-md-6">
				  	<div class="form-group">
						<label class="col-sm-4 control-label">
							Kata kunci lama <span class="text-danger">*</span>
						</label>
						<div class="col-sm-8">
				  	...
				  	<div class="form-group">
						<label class="col-sm-4 control-label">
							Kata kunci baru <span class="text-danger">*</span>
						</label>
						<div class="col-sm-8">
				  	...
				  	<div class="form-group">
						<label class="col-sm-4 control-label">
							Konfirmasi ulang kata kunci <span class="text-danger">*</span>
						</label>
						<div class="col-sm-8">
