...
class Profile_model extends CI_Model {
	...
	function updateam($id, $am){
		$data = array( 'aboutme' => $am );
		$this->db->where('id', $id);
		$this->db->update('users', $data);
	...
	public function update_photo($id, $imgdata) {
		$data = array('photo' => $imgdata);
		$this->db->where('id', $id);
		$this->db->update('users', $data);
	...
	public function getprofile($id) {
		...
		$this->db->select('*');
		$this->db->from('users');
		$this->db->join('province', 'province.id_province = users.province', 'inner');
		$this->db->join('city', 'city.id_city = users.city', 'inner');
		$this->db->where('id', $id);
		$result = $this->db->get();
